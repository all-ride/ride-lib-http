...
class Cookie {
     ...
     * @return null
     * @throws pallo\library\http\exception\HttpException when a invalid value
     * has been provided
     */
     ...
     * @param string $name Name of the cookie
     * @throws pallo\library\http\exception\HttpException when the name is
     * invalid or empty
     */
     ...
     * @throws pallo\library\http\exception\HttpException when the value is not
     * a scalar value
     */
     ...
     * @param string $path
     * @return null
     * @throws pallo\library\http\exception\HttpException when the provided path
     * is invalid or empty
     */
     ...
     * @param boolean $flag
     * @return null
     * @throws pallo\library\http\exception\HttpException when the provided flag
     * is not a boolean
     */
